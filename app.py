...
def create_table():
    ...
    try:
        ...
        c.execute(
            "INSERT INTO students (name, age, gender, email, phone) VALUES ('Badri', '37', 'Male', "
            "'badriesebua@randatmail.com	', '734-554-433')")
        # c.execute("INSERT INTO students (name, age, gender, email, phone) VALUES ('Giorgi', '45', 'Male',
        # 'Giorgi@randatmail.com	', '745-667-234')") c.execute("INSERT INTO students (name, age, gender, email,
        # phone) VALUES ('Ani', '78', 'Female', 'Ani@gmail.com	', '879-766-904')") c.execute("INSERT INTO students (
        # name, age, gender, email, phone) VALUES ('Luka', '56', 'Male', 'Luka@randatmail.com	', '239-346-265')")
